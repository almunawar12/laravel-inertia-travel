export default function TextArea({ label, className, errors, ...props }) {
    return (
        <div className="flex flex-col gap-2">
            ...
            <textarea
                className={`w-full px-4 py-2 border text-sm rounded-md focus:outline-none focus:ring-0 bg-white text-gray-700 focus:boder-gray-200 border-gray-200 ${className}`}
                {...props}
            />
